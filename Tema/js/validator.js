...
var validator = (function($){
    ...
    */
    message = {
        ...
        checked         : 'İşaretlemeniz gerek',
        empty           : 'Boş olamaz',
        min             : 'Çok kısa',
        max             : 'Çok uzun',
        number_min      : 'Çok düşük',
        number_max      : 'Çok yüksek',
        url             : 'Geçersiz URL',
        number          : 'Numara girin',
        email           : 'Geçersiz e-posta',
        email_repeat    : 'E-posta uyuşmuyor',
        password_repeat : 'Şifre uyuşmuyor',
        repeat          : 'Uyuşma Yok',
        complete        : 'Giriş tamamlanmadı',
