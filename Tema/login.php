...
<html lang="tr_TR">
  <head>
	...
	<meta name="description" content="Çiftliğini kur. üretime başla ve gerçek para kazan" />
    <meta name="keywords" content="Çiftliğini kur, üretime başla ve para kazan, oyun oyna para kazan" />
...
if(isset($_POST['username']) && isset($_POST['pass'])) {
	...
	?><br>
            <form action ="login.php" method = "post">
              ...
              <img src="http://i.hizliresim.com/77OREN.png" alt="" height="225px"> <h2>Çiftlik Giriş</h2><hr />
        ...
        <div id="register" class="animate form registration_form">
		  ...
		  ?>
            <form action ="login.php?ref=<?php echo $ref; ?>" method= "post">
              ...
              <div class="clearfix"></div>
<div id="">Sitemize üye olan tüm kullanıcılarımız <br><a href="/uyelik_sozlesmesi.php">Kullanıcı Sözleşmemizi</a><br> okumuş ve kabul etmiş sayılır !</div>
              <div class="separator">
...
<script type="text/javascript">window.$ondestek||(window.$ondestek=function(){var e=document.createElement("script");e.type="text/javascript",e.src="https://panel.ondestek.com/client/client.js?s=aa5740e9-4033-445d-bb4e-21b0828c6200",e.async=!0;var t=document.getElementsByTagName("head")[0];t.insertBefore(e,t.firstChild)})();</script>
<!-- OnDestek Kod Bitişi -->
...
<script type="text/javascript" src="//say.ac/v2.php?sid=19474"></script>
